    ...
    return (
            ...
            <div className='container'>
                ...
                <div className='span-3 img-details'>
                    <div className='top'>
                        ...
                        <p>House for Sale</p>
                        <p className='price'>N200,000,000</p>
                    </div>
                    <div className='info-grid'>
                        ...
                        <div>
                            ...
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>N2,000,000/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className='container'>
                ...
                <div className='span-3 img-details order-6'>
                    <div className='top'>
                        <h2>Lekki, Lagos, Nigeria</h2>
                        <p>House for Sale</p>
                        <p className='price'>N156,000,000</p>
                    </div>
                    <div className='info-grid'>
                        <div>
                            <div className='info'>
                        ...
                        <div>
                            ...
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>N1,000,000/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
